...
EDITABLE_KEYS = {
    ...
    "alert_feels_high",
    "alert_feels_low",
    "alert_temp_drop_warn",
    "alert_temp_drop_strong",
    "alert_temp_rise_warn",
    "alert_temp_rise_strong",
    "alert_temp_trend_window_min",
    ...
    "weathercloud_enabled", "weathercloud_id", "weathercloud_key", "weathercloud_interval",
    "windy_enabled", "windy_station_id", "windy_station_password", "windy_interval",

      ...
      <div className="card">
        <div className="grid gap-x-2 gap-y-6 justify-items-center" style={{ gridTemplateColumns: `repeat(auto-fit, minmax(${g}px, 1fr))` }}>
          <AnalogGauge title="Temperatura" size={g}
            ...
            min={u.tempN(-20)} max={u.tempN(50)} majorStep={imp ? 20 : 10} minorStep={imp ? 4 : 2}
          ...
          <AnalogGauge title="Punto de rocío" size={g}
            ...
            min={u.tempN(-10)} max={u.tempN(30)} majorStep={imp ? 10 : 10} minorStep={2}
            unit={u.tempU} decimals={1}
          ...
          <AnalogGauge title="Humedad" size={g}
            ...
            min={0} max={100} majorStep={20} minorStep={4}
            unit="%" decimals={0}
          ...
          <AnalogGauge title="Viento" size={g}
            ...
            min={0} max={u.windN(100)} majorStep={imp ? 10 : 20} minorStep={imp ? 2 : 4}
          ...
          <AnalogGauge title="Presión" size={g}
            ...
            min={u.pressN(950)} max={u.pressN(1050)} majorStep={imp ? 0.5 : 20} minorStep={imp ? 0.1 : 4}
          ...
          <AnalogGauge title="Lluvia (hoy)" size={g}
            ...
            min={0} max={u.rainN(50)} majorStep={imp ? 0.5 : 10} minorStep={imp ? 0.1 : 2}
          ...
          <AnalogGauge title="Tasa de lluvia" size={g}
            ...
            min={0} max={u.rateN(20)} majorStep={imp ? 0.2 : 4} minorStep={imp ? 0.05 : 1}
          ...
          <AnalogGauge title="UV" size={g}
            ...
            min={0} max={12} majorStep={2} minorStep={0.5}
          ...
          <AnalogGauge title="Radiación solar" size={g}
            ...
            min={0} max={1200} majorStep={200} minorStep={40}
            unit="W/m²" decimals={0}
          ...
          <AnalogGauge title="Base de nubes" size={g}
            ...
            min={0} max={imp ? 10000 : 3000} majorStep={imp ? 2000 : 500} minorStep={imp ? 400 : 100}

      ...
      {hayFoto ? (
        <>
          ...
          {/* Banda de análisis del cielo, pegada al pie. Degradado para leerse sobre
              cualquier cielo, claro u oscuro --un poco más oscuro que antes (0.9→0.94,
              0.72→0.82), pero SIGUE siendo degradado y no un panel sólido: contra un
              cielo muy claro la foto tiene que asomar un poco detrás del texto, no
              quedar tapada por una plasta negra. */}
          {hayAnalisis && (
            <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0,
              padding: '20px 22px 14px',
              background: 'linear-gradient(to top, rgba(0,0,0,0.94) 0%, rgba(0,0,0,0.82) 55%, rgba(0,0,0,0) 100%)' }}>

    ...
    return (
      <div data-kiosk-ready={ready ? 'true' : 'false'} className="cns"
        ...
        <div style={{
          ...
          <div className="cell" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', paddingTop: 2 }}>
            <div style={{ color: '#fff', fontSize: 14, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1, marginBottom: -4 }}>{cond.label || 'CLIMA'}</div>
            <WeatherIcon name={cond.icon} size={150} className="weather-main-icon" />
          </div>
          ...
          <div className="cell">
            ...
            <div style={{ position: 'absolute', top: '50%', left: 12, transform: 'translateY(-50%)' }}>
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                ...
                <path d="M20 10 L20 20" stroke="#2ab7f4" strokeWidth="2" strokeLinecap="round" />
                <path d="M11 16 L11 24" stroke="#2ab7f4" strokeWidth="2" strokeLinecap="round" />
                <path d="M17 18 L17 26" stroke="#2ab7f4" strokeWidth="2" strokeLinecap="round" />
              </svg>
            </div>

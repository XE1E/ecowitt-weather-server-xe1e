 ...
 * es un contenido con entidad —y a futuro tendrá timelapse— y en el kiosco también
    ...
    <div>
      ...
      <PageInfo>
        ...
        <p className="mt-2">
          ...
          timelapse del día— dice más que el directo. La cámara está en la red de casa y nunca se expone

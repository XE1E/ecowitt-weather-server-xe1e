              ...
              <div className="h-72 md:h-52 overflow-x-auto chart-scroll">
                <div style={{ minWidth: minW, height: '100%' }}>
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    <Legend wrapperStyle={{ fontSize: 12 }} iconType="circle" />
                      <Bar yAxisId="r" dataKey="rain" name="Tasa de lluvia" fill="#0ea5e9" radius={[3, 3, 0, 0]} />
                      <Line yAxisId="p" type="monotone" dataKey="press" name="Presión" stroke="#7f00b2" strokeWidth={2} dot={false} connectNulls />
                    </ComposedChart>
                  </ResponsiveContainer>
                </div>
              </div>
